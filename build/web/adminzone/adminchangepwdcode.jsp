...
<%
    ...
    if(newpassword.equals(confirmpassword))
    {
       ...
       {
           out.print("<script>alert('Password is not change');window.location.href='adminchangepassword.jsp';</script>");
       }
    } 
    
    else
    {
        out.print("<script>alert('New Password and Confirm Password are not same';window.location.href='adminchangepassword.jsp';</script>");
    }
 %>